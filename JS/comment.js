...
function postFirstComment() {
    ...
    if (!comment) {
        ...
        let temp_html = `<li> <span style="font-weight:460;"> baesuzyfan </span>  ${comment}</li>`
...
function postSecondComment() {
    ...
    if (!comment) {
        ...
        let temp_html = `<li> <span style="font-weight:460;"> ayanokojikiyotaka </span>  ${comment}</li>`
...
function postThirdComment() {
    ...
    if (!comment) {
        ...
        let temp_html = `<li> <span style="font-weight:460;"> arnoldhein </span>  ${comment}</li>`
